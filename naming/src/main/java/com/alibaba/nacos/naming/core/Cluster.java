...
public class Cluster extends com.alibaba.nacos.api.naming.pojo.Cluster implements Cloneable {
    ...
    public void updateIps(List<Instance> ips, boolean ephemeral) {
        ...
        //心跳检测只会更新 ephemeralInstances 状态
        //ips 是从 Datum 来的，而 Datum 是用老Datum和老ephemeralInstances合并更新来的，中间又走了阻塞队列
        //来到这里，ephemeralInstances 只会比 ips 要新
        //所以找出他们两个集合的交集
        ...
        if (updatedIPs.size() > 0) {
            for (Instance ip : updatedIPs) {
                ...
                if (!ip.isMarked()) {
                    //oldIP 就是 ephemeralInstances，把他更新到 ips
